                    ...
                    <div className="shadow rounded-lg" key={index}>
                      <div className="flex justify-between rounded-lg p-1">
                        <div className="flex space-x-2">
                          <img src={per.salonId.image} className="h-24 w-28 object-center hidden md:block rounded-l-lg" alt="" />
                          <div className="pt-1">
                            <h1 className="text-[#605555] text-lg uppercase">{per.salonId.venueName}</h1>
