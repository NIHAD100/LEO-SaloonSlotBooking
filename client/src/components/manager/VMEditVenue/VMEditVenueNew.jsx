...
function VmVenueAddNew() {
  ...
  useEffect(() => {
    ...
    (async () => {
      let { data } = await axios.get(`/vm/salon/${id}`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let { data } = await axios.put(
        "/vm/salon",
        { id, venueName, mobile, district, place, actualPrice, discountPercentage, description, image: imageUrl, document: documentUrl, slots, lat, lng },
        {
          headers: {
            Authorization: token,
          },
